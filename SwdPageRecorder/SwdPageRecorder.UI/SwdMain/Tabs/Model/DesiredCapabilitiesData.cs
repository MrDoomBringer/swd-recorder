...
namespace SwdPageRecorder.UI
{
	public class DesiredCapabilitiesData
	{
		...
		private const string catUsedBySelServerForBrowserSelection = "Used by the selenium server for browser selection";
		...
		private const string catReadonlyCapabilities = "Read-only capabilities";
		...
		private const string catReadWriteCapabilities = "Read-write capabilities";
